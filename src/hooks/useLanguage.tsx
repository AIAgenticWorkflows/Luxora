...
const translations = {
  ...
  fr: {
    ...
    'location.transport.title': 'Transport',
    'location.transport.description': 'Accès facile aux transports en commun et à environ 1 heure de route de l\'aéroport international Sir Seewoosagur Ramgoolam.',

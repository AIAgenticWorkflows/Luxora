              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-serif font-bold">Phone</h4>
                      <p className="text-gray-600">+230 5XXX XXXX</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-serif font-bold">Email</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-serif font-bold">Address</h4>
                      <p className="text-gray-600">Luxora Villa, Pereybere, Mauritius</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    {/* Social Media Icons */}
                    <a href="#" className="bg-luxury-blue text-white p-2 rounded-full hover:bg-opacity-80 transition-colors">
